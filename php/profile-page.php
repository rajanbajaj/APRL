                    ...
                    <div class="modal-body">
                        <div class="content">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" class="form-control" value=<?php echo '"'.$credential.'"'?> name="Credential">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons text_caps-small"></i>
                                </span>
                                <input class="form-control" value=<?php echo '"'.$description.'"'?> name="Description"> </input>
                            </div>
                        </div>
                        <div class="footer text-center">
