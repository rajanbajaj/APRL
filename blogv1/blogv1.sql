...
--
-- Host: localhost
-- Generation Time: Nov 03, 2017 at 02:08 AM
...
INSERT INTO `blog` (`blog_id`, `tag`, `description`, `date`, `url`, `spam`, `likes`, `reads`, `title`) VALUES
(1, 'Andoroid', 'This is my description of journey', '2017-11-03 02:03:38', 'no url', 3, 1900, 7000, 'Journey To End Of Earth');
...
('r', 'king', 'khan', 'kingkhan@pinkworld.com', 'stdrfygthujklm,njbkhjvgcfh', 'ghanta', 'im not a terrorist');
